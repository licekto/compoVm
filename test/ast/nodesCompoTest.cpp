...
BOOST_AUTO_TEST_CASE(symbolTest) {
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::SYMBOL, symbol.getNodeType());
    BOOST_CHECK_EQUAL("Symbol", symbol.getStringValue());
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::SYMBOL, symbolCopy1.getNodeType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::SYMBOL, symbol.getNodeType());
    BOOST_CHECK_EQUAL("Symbol", symbol.getStringValue());
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::SYMBOL, symbolCopy2.getNodeType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::SYMBOL, symbolNew1.getNodeType());
    BOOST_CHECK_EQUAL("", symbolNew1.getStringValue());
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::SYMBOL, symbolNew2.getNodeType());
...
BOOST_AUTO_TEST_CASE(portTest) {
    ...
    ast::nodes::compo::CPort port(ast::nodes::types::portType::UNIVERSAL, new_ptr(ast_symbol)("port"), true);
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::PORT, port.getNodeType());
...
BOOST_AUTO_TEST_CASE(injectedPortTest) {
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::INJECTED_PORT, port.getNodeType());
...
BOOST_AUTO_TEST_CASE(provisionTest) {
    ...
    std::vector<ptr(ast::nodes::compo::CPort)> portVec;
    portVec.push_back(new_ptr(ast::nodes::compo::CUniversalPort)(new_ptr(ast_symbol)("port1"), true, false));
    portVec.push_back(new_ptr(ast::nodes::compo::CUniversalPort)(new_ptr(ast_symbol)("port2"), false, false));
    
    // Original provision creation
    ast_provision provision(ast::nodes::types::visibilityType::EXTERNAL, portVec);
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::PROVISION, provision.getNodeType());
    BOOST_CHECK_EQUAL(ast::nodes::types::visibilityType::EXTERNAL, provision.getVisibilityType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::PROVISION, provisionCopy1.getNodeType());
    BOOST_CHECK_EQUAL(ast::nodes::types::visibilityType::EXTERNAL, provisionCopy1.getVisibilityType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::PROVISION, provisionCopy2.getNodeType());
    BOOST_CHECK_EQUAL(ast::nodes::types::visibilityType::EXTERNAL, provisionCopy2.getVisibilityType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::PROVISION, provisionNew1.getNodeType());
    BOOST_CHECK_EQUAL(ast::nodes::types::visibilityType::EXTERNAL, provisionNew1.getVisibilityType());
    ...
    // Test of moved requirement
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::PROVISION, provisionNew2.getNodeType());
    BOOST_CHECK_EQUAL(ast::nodes::types::visibilityType::EXTERNAL, provisionNew2.getVisibilityType());
...
BOOST_AUTO_TEST_CASE(requirementTest) {
    // Port vector preparation
    std::vector<ptr(ast::nodes::compo::CPort)> portVec;
    portVec.push_back(new_ptr(ast::nodes::compo::CUniversalPort)(new_ptr(ast_symbol)("port1"), true));
    portVec.push_back(new_ptr(ast::nodes::compo::CUniversalPort)(new_ptr(ast_symbol)("port2"), false));
    
    // Original requirement creation
    ast_requirement requirement(ast::nodes::types::visibilityType::EXTERNAL, portVec);
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::REQUIREMENT, requirement.getNodeType());
    BOOST_CHECK_EQUAL(ast::nodes::types::visibilityType::EXTERNAL, requirement.getVisibilityType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::REQUIREMENT, requirementCopy1.getNodeType());
    BOOST_CHECK_EQUAL(ast::nodes::types::visibilityType::EXTERNAL, requirementCopy1.getVisibilityType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::REQUIREMENT, requirementCopy2.getNodeType());
    BOOST_CHECK_EQUAL(ast::nodes::types::visibilityType::EXTERNAL, requirementCopy2.getVisibilityType());
    ...
    // Test of moved requirement
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::REQUIREMENT, requirementNew1.getNodeType());
    BOOST_CHECK_EQUAL(ast::nodes::types::visibilityType::EXTERNAL, requirementNew1.getVisibilityType());
    ...
    // Test of moved requirement
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::REQUIREMENT, requirementNew2.getNodeType());
    BOOST_CHECK_EQUAL(ast::nodes::types::visibilityType::EXTERNAL, requirementNew2.getVisibilityType());
...
BOOST_AUTO_TEST_CASE(serviceTest) {
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::SERVICE, serviceCopy1.getNodeType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::SERVICE, serviceCopy2.getNodeType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::SERVICE, serviceNew1.getNodeType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::SERVICE, serviceNew2.getNodeType());
...
BOOST_AUTO_TEST_CASE(constraintTest) {
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::CONSTRAINT, constraintCopy1.getNodeType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::CONSTRAINT, constraingCopy2.getNodeType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::CONSTRAINT, constraintNew1.getNodeType());
    ...
    BOOST_CHECK_EQUAL(ast::nodes::types::nodeType::CONSTRAINT, constraintNew2.getNodeType());
