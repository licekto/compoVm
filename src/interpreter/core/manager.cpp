...
namespace interpreter {
	...
	namespace core {
                    ...
                    void CMemoryManager::iterateAddPorts(std::shared_ptr<ast_reqprov> reqprov, std::function<void(memory::objects::portVisibility, memory::objects::portType, ptr(ast_port))> callback) {
                    ...
                    void CMemoryManager::addPrimitivePorts(ptr(memory::objects::CComponent) component, ptr(ast_descriptor) descriptor) {                        
                        // lambda function
                    ...
                    ptr(memory::objects::CComponent) CMemoryManager::bootstrapPortComponent(ptr(ast_port) astPort, ptr(memory::objects::CComponent) owner) {
                    ...
                    void CMemoryManager::addPorts(ptr(memory::objects::CComponent) component, ptr(ast_descriptor) descriptor) {
                        // lambda function
                        auto callback = [this, &component](memory::objects::portVisibility v, memory::objects::portType t, ptr(ast_port) port) {
                    ...
                    ptr(memory::objects::CComponent) CMemoryManager::bootstrapServiceComponent(ptr(ast_service) astService, ptr(memory::objects::CComponent) context) {
                    ...
                    std::shared_ptr<memory::objects::CComponent> CMemoryManager::bootstrapServiceSignatureComponent(ptr(ast_servicesignature) /*astSignature*/) {
                    ...
                    ptr(memory::objects::CComponent) CMemoryManager::bootstrapDescriptorComponent() {
