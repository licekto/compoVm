...
namespace ast {
	...
	namespace visitors {
            ...
            /*---------------------- abstract nodes --------------------------*/
            void CSemanticCheckVisitor::visit(ast::CNode *node) {checkNodeType(node, ast_type::CONSTRAINT);}
            void CSemanticCheckVisitor::visit(ast::compo::CAbstractReqProv *node) {checkNodeType(node, ast_type::CONSTRAINT);}
            void CSemanticCheckVisitor::visit(ast::compo::CAbstractServConstr *node) {checkNodeType(node, ast_type::CONSTRAINT);}            
            void CSemanticCheckVisitor::visit(ast::compo::CBind *node) {checkNodeType(node, ast_type::CONSTRAINT);}
            void CSemanticCheckVisitor::visit(ast::compo::CPort *node) {checkNodeType(node, ast_type::CONSTRAINT);}
            
            void CSemanticCheckVisitor::visit(ast::procedural::CAbstractExpression *node) {checkNodeType(node, ast_type::CONSTRAINT);}
            void CSemanticCheckVisitor::visit(ast::procedural::CAbstractPrimaryExpression *node) {checkNodeType(node, ast_type::CONSTRAINT);}
            void CSemanticCheckVisitor::visit(ast::procedural::CAbstractStatement *node) {checkNodeType(node, ast_type::CONSTRAINT);}
            void CSemanticCheckVisitor::visit(ast::procedural::CBinaryExpression *node) {checkNodeType(node, ast_type::CONSTRAINT);}
            /*----------------------------------------------------------------*/
